...
def init_db():
    ...
    try:
        with conn.cursor() as cursor:
            ...
            cursor.execute("""
                CREATE TABLE IF NOT EXISTS axienta_sales_sync (
                    ...
                    category4 VARCHAR(150),
                    category5 VARCHAR(150),
                    item_id VARCHAR(100),
                    ...
                    type_txn VARCHAR(100),
                    line_type VARCHAR(100),
                    outlet_business_type VARCHAR(100),
                    type VARCHAR(100),
